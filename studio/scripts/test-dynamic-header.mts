...
const checks: Array<[string, boolean]> = [
	...
	['Organization+LocalBusiness', php.includes('LocalBusiness') && php.includes('Organization') && php.includes('knowsAbout')],
	...
	['direct echo (no ob_start)', !php.includes('ob_start(') && php.includes('redue_echo_canonical_pair')],
	...
	['sameAs', php.includes("'sameAs' => $same_as_array") || php.includes("'sameAs' => array($origin")],
	['Person E-E-A-T', php.includes("$origin . '/#person'") && php.includes('worksFor')],
	...
	['LocalBusiness NAP type', php.includes('LocalBusiness')],
	['protocol detect', php.includes('redue_detect_site_protocol')],
