...
export function Footer({ clearFloatingBar = false }: { clearFloatingBar?: boolean }) {
	...
	return (
		<footer
			id="site-footer"
			className={`site-footer print:hidden mt-auto mb-0 w-full border-t border-white/10 bg-slate-950 p-0 text-xs text-slate-400${
				...
				<div className="flex flex-col gap-10">
					...
					<div className="flex flex-col gap-2">
						<div className="flex items-center gap-2">
							...
							<span className="text-sm font-semibold text-slate-200">{t('brandName')}</span>
						</div>
					...
					<div className="footer-info-list flex flex-col gap-2 leading-relaxed">
						<p className="footer-info-row flex flex-wrap gap-x-3 gap-y-1">
							<span>
								...
								<span className="text-slate-300">{t('ceo')}</span>
							</span>
							<span className="footer-info-sep text-white/15" aria-hidden>
								|
							</span>
							<span>
						...
						<p className="footer-info-row flex flex-wrap gap-x-3 gap-y-1">
							<span>
								...
								<span className="text-slate-300">{t('bizNo')}</span>
							</span>
							<span className="footer-info-sep text-white/15" aria-hidden>
								|
							</span>
							<span>
								...
								<span className="text-slate-300">{t('mailOrder')}</span>
							</span>
						</p>
					...
					<div className="footer-bottom flex flex-col gap-4 border-t border-white/[0.06] pt-8 sm:flex-row sm:items-center sm:justify-between">
						<nav
