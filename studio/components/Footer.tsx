			...
			<div className="mx-auto w-full max-w-5xl px-6">
				<div className="mb-8 flex flex-col items-start justify-between gap-4 border-b border-slate-200 pb-8 sm:flex-row sm:items-center dark:border-slate-800/70">
					...
					<div className="flex flex-wrap items-center gap-2">
						...
						<Link
							href="/#audit-hero"
							className="rounded-lg border border-slate-300 bg-white px-3 py-1.5 text-xs font-medium text-slate-800 shadow-sm transition-all hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-800 dark:text-white dark:shadow-none dark:hover:bg-slate-700"
						>
							{t('auditCta')}
						</Link>
					</div>
